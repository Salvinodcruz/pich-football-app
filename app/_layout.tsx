      ...
      <SafeAreaProvider>
        <DialogProvider>
          ...
          >
            ...
            {/* Detail screens â€” swipe back enabled */}
            ...
            <Stack.Screen name="player-profile" options={{ headerShown: false, gestureEnabled: true }} />
            ...
            {/* ── New feature screens ── */}
            <Stack.Screen name="ai-highlights" options={{ headerShown: false, gestureEnabled: true }} />
            <Stack.Screen name="pitches" options={{ headerShown: false, gestureEnabled: true }} />

            {/* ── Match Engine ── */}
            <Stack.Screen name="match-engine" options={{ headerShown: false, gestureEnabled: false }} />
          </Stack>
