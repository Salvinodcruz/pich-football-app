...
const styles = StyleSheet.create({
  ...
  searchSection: { backgroundColor: '#141414CC', borderRadius: BorderRadius.md, padding: Spacing.md, marginBottom: Spacing.lg, borderWidth: 1, borderColor: '#2A2A2A' },
  sectionLabel: { color: '#aaa', fontSize: FontSizes.xs, fontWeight: FontWeights.bold, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: Spacing.sm },
  searchRow: { flexDirection: 'row', gap: Spacing.sm },
  searchInput: { flex: 1, backgroundColor: '#0A0A0A', borderRadius: BorderRadius.md, padding: Spacing.md, color: '#fff', fontSize: FontSizes.sm, borderWidth: 1, borderColor: '#2A2A2A' },
  ...
  searchResultCard: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, backgroundColor: '#0A0A0A', borderRadius: BorderRadius.md, padding: Spacing.md, marginTop: Spacing.sm, borderWidth: 1, borderColor: Colors.dark.tint + '40' },
  ...
  tab: { flex: 1, paddingVertical: Spacing.sm, borderRadius: BorderRadius.md, backgroundColor: '#141414', borderWidth: 1, borderColor: '#2A2A2A', alignItems: 'center' },
  ...
  list: { gap: Spacing.xs },
  friendRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, backgroundColor: '#141414CC', borderRadius: BorderRadius.md, padding: Spacing.md, borderWidth: 1, borderColor: '#2A2A2A' },
  requestRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, backgroundColor: '#141414CC', borderRadius: BorderRadius.md, padding: Spacing.md, borderWidth: 1, borderColor: Colors.dark.tint + '30' },
  ...
  dmBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#1A1A1A', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#2A2A2A' },
  dmBtnText: { fontSize: 16 },
  removeBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#1A1A1A', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#FF444430' },
  removeBtnText: { color: '#FF4444', fontSize: FontSizes.sm },
